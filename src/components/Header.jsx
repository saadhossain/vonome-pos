...
const Header = () => {
    ...
    return (
        <div className='border-b border-secondary sticky top-0 bg-background z-50'>
            <div className='w-full md:w-11/12 mx-auto md:ml-auto flex items-center justify-between px-2 md:px-0 py-2 md:py-4'>
                ...
                <div className='w-full md:hidden flex items-center justify-between gap-2'>
                    <div className='flex items-center gap-2'>
                        ...
                        <div className='flex items-center bg-success/20 rounded-3xl'>
                            <Link to='/' className={`flex items-center gap-1 font-medium py-1 px-3 rounded-3xl ${pathName === '/' && 'bg-success/60 text-white'}`}><FaListCheck /> Products</Link>
                            <Link to='/cart' className={`flex items-center gap-1 font-medium py-1 px-3 rounded-3xl ${pathName === '/cart' && 'bg-success/60 text-white'}`}><BsHandbag /> Cart</Link>
                        </div>
                    </div>
                    <div className='flex items-center gap-2'>
